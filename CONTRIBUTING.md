# Contributing to Snowy

Thank you for your interest in contributing to Snowy! This guide covers local setup, project conventions, and what we look for in pull requests.
...
Before starting large features, open an issue or discuss in the [support server](https://discord.gg/both) so we can align on scope and avoid duplicate work.
